...
+ (instancetype)actionWithTitle:(nullable NSString *)title style:(SLAlertActionStyle)style handler:(void (^ __nullable)(SLAlertAction *action))handler {
    SLAlertAction *action = [[self alloc] initWithTitle:title style:(SLAlertActionStyle)style handler:handler];
    return action;
    
}

- (instancetype)initWithTitle:(nullable NSString *)title style:(SLAlertActionStyle)style handler:(void (^ __nullable)(SLAlertAction *action))handler {
    if (self = [super init]) {
        ...
        if (style == SLAlertActionStyleDestructive) {
            self.titleColor = [UIColor redColor];
        } else if (style == SLAlertActionStyleCancel) {
...
#pragma mark ---------------------------- SLAlertAction end --------------------------------

#pragma mark ---------------------------- SLAlertControllerActionCell begin --------------------------------

@interface SLAlertControllerActionCell : UITableViewCell
@property (nonatomic, strong) SLAlertAction *action;
...
@implementation SLAlertControllerActionCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        // footerCell指的是SLAlertControllerStyleActionSheet下的取消cell和SLAlertControllerStyleAlert下actions小于_maxNumberOfActionHorizontalArrangementForAlert时的cell
...
- (void)setAction:(SLAlertAction *)action {
    _action = action;
...
@end
#pragma mark ---------------------------- SLAlertControllerActionCell end --------------------------------


#pragma mark ---------------------------- SLAlertController begin --------------------------------

@interface SLAlertController () <UIViewControllerTransitioningDelegate,UITableViewDataSource,UITableViewDelegate>
...
// action数组
@property (nonatomic) NSArray<SLAlertAction *> *actions;
// 取消样式的action数组
...
@property (nonatomic, assign) SLAlertControllerStyle preferredStyle;
@property (nonatomic, assign) SLAlertAnimationType animationType;
// 底部的cell数组
...
@property (nonatomic, assign) SLBackgroundViewAppearanceStyle backgroundViewAppearanceStyle;
...
+ (instancetype)alertControllerWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType {

    SLAlertController *alertController = [self alertControllerWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil];
    
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType customView:(UIView *)customView {
    // 创建控制器
    SLAlertController *alertController = [[SLAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:customView customHeaderView:nil customCenterView:nil customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithPreferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType customHeaderView:(nullable UIView *)customHeaderView {
    // 创建控制器
    SLAlertController *alertController = [[SLAlertController alloc] initWithTitle:nil message:nil preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:customHeaderView customCenterView:nil customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType customCenterView:(UIView *)customCenterView {
    // 创建控制器
    SLAlertController *alertController = [[SLAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:nil customCenterView:customCenterView customFooterView:nil];
    return alertController;
}

+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType customFooterView:(UIView *)customFooterView {
    // 创建控制器
    SLAlertController *alertController = [[SLAlertController alloc] initWithTitle:title message:message preferredStyle:preferredStyle animationType:animationType customView:nil customHeaderView:nil customCenterView:nil customFooterView:customFooterView];
    return alertController;
}
...
- (void)addAction:(SLAlertAction *)action {
    ...
    if (self.cancelActions.count && self.preferredStyle == SLAlertControllerStyleActionSheet) {
        if (action.style == SLAlertActionStyleCancel) { // 取消样式的按钮顺序排列
    ...
    if (self.preferredStyle == SLAlertControllerStyleActionSheet) {
        if (self.customCenterView && action.style != SLAlertActionStyleCancel) {
            NSLog(@"当自定义centerView时，SLAlertControllerStyleActionSheet下，除了取消样式的按钮之外，其余样式的按钮均不显示");
            [array removeObject:action];
            self.actions = array;
            [self layoutViewConstraints];
            return;
        }
        if (action.style == SLAlertActionStyleCancel && !self.customFooterView) {
        ...
        if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert && !self.customFooterView) {
            ...
            if (self.customCenterView) {
                NSLog(@"当自定义centerView时，SLAlertControllerStyleAlert下，action的个数最多只能是_maxNumberOfActionHorizontalArrangementForAlert个，超过_maxNumberOfActionHorizontalArrangementForAlert个的action将不显示");
                [array removeObject:action];
                self.actions = array;
                return;
            }
    ...
    action.propertyEvent = ^(SLAlertAction *action) {
        if (weakSelf.preferredStyle == SLAlertControllerStyleActionSheet) {
            if (action.style == SLAlertActionStyleCancel) {
                NSInteger index = [weakSelf.cancelActions indexOfObject:action];
                // 注意这个cell是与tableView没有任何瓜葛的
                SLAlertControllerActionCell *footerCell = [weakSelf.footerCells objectAtIndex:index];
            ...
            if (weakSelf.actions.count <= maxNumberOfActionHorizontalArrangementForAlert) {
                ...
                SLAlertControllerActionCell *footerCell = weakSelf.footerCells[index];
                footerCell.action = action;
            } else {
                [weakSelf.actionTableView reloadData];
            }
...
- (void)addTextFieldWithConfigurationHandler:(void (^)(UITextField * _Nonnull))configurationHandler {
    ...
    NSAssert(self.preferredStyle == SLAlertControllerStyleAlert, @"SLAlertControllerStyleActionSheet样式拒绝添加文本输入框");
...
- (void)setBackgroundViewAppearanceStyle:(SLBackgroundViewAppearanceStyle)style alpha:(CGFloat)alpha {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SLAlertControllerActionCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([SLAlertControllerActionCell class]) forIndexPath:indexPath];
    SLAlertAction *action = self.dataSource[indexPath.row];
    cell.action = action;
    return cell;
}
...
- (void)tableView:(UITableView *)tableView willDiSLlayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    // 设置cell分割线整宽
...
#pragma mark - Private
- (instancetype)initWithTitle:(nullable NSString *)title message:(nullable NSString *)message preferredStyle:(SLAlertControllerStyle)preferredStyle animationType:(SLAlertAnimationType)animationType customView:(UIView *)customView customHeaderView:(UIView *)customHeaderView customCenterView:(UIView *)customCenterView customFooterView:(UIView *)customFooterView{
    ...
    if (self = [super init]) {
        ...
        if (animationType == SLAlertAnimationTypeDefault) {
            if (self.preferredStyle == SLAlertControllerStyleAlert) {
                animationType= SLAlertAnimationTypeAlpha;
            } else if (self.preferredStyle == SLAlertControllerStyleActionSheet) {
                animationType = SLAlertAnimationTypeRaiseUp;
            } else {
                animationType = SLAlertAnimationTypeRaiseUp;
            }
        }
...
//            // Fallback on earlier versions
//        }
        [actionTableView registerClass:[SLAlertControllerActionCell class] forCellReuseIdentifier:NSStringFromClass([SLAlertControllerActionCell class])];
...
- (void)createFooterCellWithAction:(SLAlertAction *)action {
    ...
    SLAlertControllerActionCell *footerCell = [[SLAlertControllerActionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:FOOTERCELL];
...
- (void)clickedFooterCell:(UIButton *)sender {
    ...
    if (self.preferredStyle == SLAlertControllerStyleActionSheet) {
        SLAlertControllerActionCell *footerCell = (SLAlertControllerActionCell *)sender.superview;
        NSInteger index = [self.footerCells indexOfObject:footerCell];
        SLAlertAction *action = [self.cancelActions objectAtIndex:index];
        // 回调action的block
        if (action.handler) {
            action.handler(action);
        }
        ...
        if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
            SLAlertControllerActionCell *footerCell = (SLAlertControllerActionCell *)sender.superview;
            NSInteger index = [self.footerCells indexOfObject:footerCell];
            SLAlertAction *action = [self.actions objectAtIndex:index];
            // 回调action的block
            if (action.handler) {
                action.handler(action);
            }
...
- (void)layoutFooter {
    ...
    if ((self.preferredStyle == SLAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == SLAlertControllerStyleAlert && (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) && self.actions.count)) { // 需要footerBezelView
        if (self.preferredStyle == SLAlertControllerStyleAlert) { // alert样式
    ...
    if (!self.customFooterView) { // 不是自定义的footerView
        ...
        if (footerCells.count && ((self.preferredStyle == SLAlertControllerStyleActionSheet && self.cancelActions.count) || (self.preferredStyle == SLAlertControllerStyleAlert && self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert))) {
            [footerCells enumerateObjectsUsingBlock:^(SLAlertControllerActionCell *footerCell, NSUInteger idx, BOOL * _Nonnull stop) {
                if (self.preferredStyle == SLAlertControllerStyleAlert) {
                    // 设置footerCell的上下间距
...
- (CGFloat)actionBezelHeight:(CGFloat)footerTopMargin {
    ...
    if (self.actions.count) {
        ...
        } else if (self.preferredStyle == SLAlertControllerStyleAlert) {
            if (self.actions.count <= _maxNumberOfActionHorizontalArrangementForAlert) {
...
- (void)setOffsetYForAlert:(CGFloat)offsetYForAlert {
    ...
    SLAlertPresentationController *presentationVc = (SLAlertPresentationController *)self.presentationController;
...
- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source {
    return [SLAlertAnimation animationISLresenting:YES];
}

- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForDismissedController:(UIViewController *)dismissed {
    [self.view endEditing:YES];
    return [SLAlertAnimation animationISLresenting:NO];
}

- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source NS_AVAILABLE_IOS(8_0) {
    return [[SLAlertPresentationController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
}

@end

#pragma mark ---------------------------- SLAlertController end --------------------------------

@interface SLOverlayView: UIView
@property (nonatomic, strong) UIView *presentedView;
@property (nonatomic, assign) SLAlertController *alertController;
@property (nonatomic, strong) UIVisualEffectView *effectView;
@property (nonatomic, assign) CGFloat cornerRadiusForAlert;
- (void)redrawWithView:(UIView *)view alertController:(SLAlertController *)alertController;
@end
...
- (void)setAppearanceStyle:(SLBackgroundViewAppearanceStyle)appearanceStyle alpha:(CGFloat)alpha {
    switch (appearanceStyle) {
        case SLBackgroundViewAppearanceStyleTranslucent: {
            ...
            break;
        case SLBackgroundViewAppearanceStyleBlurExtraLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleExtraLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case SLBackgroundViewAppearanceStyleBlurLight: {
            UIBlurEffect *blur = [UIBlurEffect effectWithStyle:UIBlurEffectStyleLight];
            [self createVisualEffectViewWithBlur:blur alpha:alpha];
        }
            break;
        case SLBackgroundViewAppearanceStyleBlurDark: {
...
- (void)drawRect:(CGRect)rect {
    [super drawRect:rect];
    // 黑色带透明时进行镂空
    if (self.alertController.backgroundViewAppearanceStyle == SLBackgroundViewAppearanceStyleTranslucent && self.alertController.needDialogBlur && !self.alertController.textFields.count) {
        _cornerRadiusForAlert = (self.alertController.preferredStyle==SLAlertControllerStyleActionSheet)? 0 : self.alertController.cornerRadiusForAlert;
...
#pragma mark ---------------------------- SLAlertPresentationController begin --------------------------------

@interface SLAlertPresentationController()
@property (nonatomic, weak) SLOverlayView *overlayView;
@property (nonatomic, strong) NSMutableArray *presentedViewConstraints;
@end

@implementation SLAlertPresentationController
...
- (void)didChangeStatusBarOrientation:(NSNotification *)notification {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.3 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        SLAlertController *alertController = (SLAlertController *)self.presentedViewController;
        CGFloat cornerRadius = 0;
        if (alertController.preferredStyle == SLAlertControllerStyleAlert) {
...
- (void)presentationTransitionWillBegin {
    ...
    SLOverlayView *overlayView = [[SLOverlayView alloc] init];
...
- (void)updateConstraints {
    ...
    if (!customView) { // 非自定义
        if (alertController.preferredStyle == SLAlertControllerStyleActionSheet) {
            ...
            if (alertController.animationType == SLAlertAnimationTypeDropDown) {
        ...
        } else if (alertController.preferredStyle == SLAlertControllerStyleAlert) {
...
#pragma mark ---------------------------- SLAlertPresentationController end --------------------------------


#pragma mark ---------------------------- SLAlertAnimation begin --------------------------------

@interface SLAlertAnimation()
@property (nonatomic, assign) BOOL presenting;
@property (nonatomic, assign) CGFloat delayTime;
@end

@implementation SLAlertAnimation

- (instancetype)initWithPresenting:(BOOL)iSLresenting {
    if (self = [super init]) {
        self.presenting = iSLresenting;
        _delayTime = 0.22;
    }
    return self;
}

+ (instancetype)animationISLresenting:(BOOL)iSLresenting {
    return [[self alloc] initWithPresenting:iSLresenting];
}
...
- (void)presentAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    SLAlertController *alertController = (SLAlertController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    
    // 获取presentationController，注意不是presentedController
    SLAlertPresentationController *presentedController = (SLAlertPresentationController *)alertController.presentationController;
    SLOverlayView *overlayView = presentedController.overlayView;

    switch (alertController.animationType) {
        case SLAlertAnimationTypeRaiseUp:
            [self raiseUpWhenPresentForController:alertController
                                       transition:transitionContext
                                  controlViewSize:controlViewSize
                                      overlayView:overlayView];
            break;
        case SLAlertAnimationTypeDropDown:
...
- (void)dismissAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    SLAlertController *alertController = (SLAlertController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    CGSize controlViewSize = alertController.view.bounds.size;
    // 获取presentationController，注意不是presentedController
    SLAlertPresentationController *presentedController = (SLAlertPresentationController *)alertController.presentationController;
    SLOverlayView *overlayView = presentedController.overlayView;
    ...
    switch (alertController.animationType) {
        case SLAlertAnimationTypeRaiseUp:
            [self dismissCorreSLondingRaiseUpForController:alertController
                                                transition:transitionContext
                                           controlViewSize:controlViewSize
                                               overlayView:overlayView];
            break;
        case SLAlertAnimationTypeDropDown:
            [self dismissCorreSLondingDropDownForController:alertController
                                                 transition:transitionContext
                                            controlViewSize:controlViewSize
                                                overlayView:overlayView];
            break;
        ...
        case SLAlertAnimationTypeAlpha:
            [self dismissCorreSLondingAlphaForController:alertController
                                              transition:transitionContext
                                         controlViewSize:controlViewSize
                                             overlayView:overlayView];
            break;
        case SLAlertAnimationTypeExpand:
            [self dismissCorreSLondingExpandForController:alertController
                                               transition:transitionContext
                                          controlViewSize:controlViewSize
                                              overlayView:overlayView];
            break;
        case SLAlertAnimationTypeShrink:
            [self dismissCorreSLondingShrinkForController:alertController
                                               transition:transitionContext
                                          controlViewSize:controlViewSize
                                              overlayView:overlayView];
            break;
...
// 从底部忘上弹的present动画
- (void)raiseUpWhenPresentForController:(SLAlertController *)alertController
                             transition:(id<UIViewControllerContextTransitioning>)transitionContext
                        controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
// 从底部往上弹对应的dismiss动画
- (void)dismissCorreSLondingRaiseUpForController:(SLAlertController *)alertController
                             transition:(id<UIViewControllerContextTransitioning>)transitionContext
                        controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
// 从顶部往下弹的present动画
- (void)dropDownWhenPresentForController:(SLAlertController *)alertController
                              transition:(id<UIViewControllerContextTransitioning>)transitionContext
                         controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
// 从顶部往下弹对应的dismiss动画
- (void)dismissCorreSLondingDropDownForController:(SLAlertController *)alertController
                                      transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                 controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
- (void)alphaWhenPresentForController:(SLAlertController *)alertController
                             transition:(id<UIViewControllerContextTransitioning>)transitionContext
                        controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
- (void)dismissCorreSLondingAlphaForController:(SLAlertController *)alertController
                                       transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                  controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 发散的prensent动画
- (void)expandWhenPresentForController:(SLAlertController *)alertController
                           transition:(id<UIViewControllerContextTransitioning>)transitionContext
                      controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
// 发散对应的dismiss动画
- (void)dismissCorreSLondingExpandForController:(SLAlertController *)alertController
                                    transition:(id<UIViewControllerContextTransitioning>)transitionContext
                               controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
    [overlayView redrawWithView:nil alertController:nil];
...
// 收缩的present动画
- (void)shrinkWhenPresentForController:(SLAlertController *)alertController
                            transition:(id<UIViewControllerContextTransitioning>)transitionContext
                       controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
...
// 收缩对应的的dismiss动画
- (void)dismissCorreSLondingShrinkForController:(SLAlertController *)alertController
                                     transition:(id<UIViewControllerContextTransitioning>)transitionContext
                                controlViewSize:(CGSize)controlViewSize overlayView:(SLOverlayView *)overlayView {
    // 与发散对应的dismiss动画相同
    [self dismissCorreSLondingExpandForController:alertController transition:transitionContext controlViewSize:controlViewSize overlayView:overlayView ];
}

@end

#pragma mark ---------------------------- SLAlertAnimation end --------------------------------
